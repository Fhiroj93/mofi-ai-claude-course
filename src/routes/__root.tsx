...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/4fe4b7e9-2332-474a-b583-e093653404c5/id-preview-53c87756--675d21d5-d7fb-467b-a779-63e2edd95161.lovable.app-1783348868693.png" },
    ],
    links: [
